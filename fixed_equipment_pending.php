<?php
   ...
   //     }
    ...
    $fields="add_equipment.equipment_code, add_equipment.network_name, add_equipment.manufacturer, add_equipment.model, add_equipment.region, add_equipment.status";

    $whereClause="add_equipment.status='pendiente'";
			...
			<div class = "table-responsive my_scrollable_div">
                ...
                <table class="table table-sm table-striped table-hover">
                    <thead class="thead-dark">
                        <tr>
                            <th class="my_td" colspan="10">Equipos pendientes añadir:</th>
                        </tr>
                        <tr>
